...
-- Volcando estructura de base de datos para multishop
CREATE DATABASE IF NOT EXISTS `multishop` /*!40100 DEFAULT CHARACTER SET utf16 COLLATE utf16_spanish_ci */;
USE `multishop`;

-- Volcando estructura para tabla multishop.categories
...
-- Volcando estructura para tabla multishop.codes
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.comments
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.customers
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.deliveries
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.delivery_details
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.delivery_status
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.dispatch_status
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.images
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.payments
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.products
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.roles
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.slider
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.stock_message
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.stock_switch
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.subcategories
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.switch
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.users
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla multishop.zip_files
